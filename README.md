...
```
src/i18n/
  landing-page/          # Default namespace for JOD Landing page specific translations
    fi.json
    en.json
    sv.json
...
- **`landing-page`** - Contains JOD Landing page specific translations (default namespace)

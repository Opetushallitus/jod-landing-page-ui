      ...
      <Accordion
        ...
        title={
          <div className="flex items-center gap-4">
            <div className="bg-secondary-gray flex size-7 items-center justify-center rounded-full text-white">
              {icon}
            </div>
            {title}
          </div>
        ...
        className="w-full"
      >
        <section id={contentId} className="font-arial text-body-md-mobile sm:text-body-md mt-3 mb-6 ml-[44px]">
          {content}
        </section>
      </Accordion>
    </div>
  ...
  return (
    <main role="main" className="mx-auto w-full max-w-(--breakpoint-xl) bg-white pb-11" id="jod-main">
      ...
      <Content title={t('home.welcome.title')} className="mt-7 lg:mt-8" verticalPaddingClass="pt-7 lg:pt-8">
        <p className="text-body-lg max-w-[716px] whitespace-pre-line">{t('home.welcome.content')}</p>
      </Content>
      ...
      <Content title={t('home.competency-path-help.you.title')} headingLevel={2} headingClassName="max-w-[748px]!">
        <div className="text-body-lg flex max-w-[748px] flex-col gap-5 whitespace-pre-line sm:gap-6">
                ...
                components={{
                  ...
                  CustomLink: (
                    <Link
                      ...
                      className="text-accent inline-flex items-center underline"
                      target="_blank"
